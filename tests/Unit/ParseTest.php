...
class ParseTest extends BootsApp
{
    ...
    public function testThread()
    {
        ...
        $this->assertEquals('Can you find me?', parseTitleFromHTML('<html><head><title>PHP-ISSO Unit Test</title></head><body><header><h1>generic website title</h1></header><article><header><h1>Can you find me?</h1></header></article></body></html>'));
    }
}